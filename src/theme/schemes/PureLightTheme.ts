...
const colors = {
  ...
  alpha: {
    ...
    purple: {
      5: alpha(themeColors.purple, 0.02),
      10: alpha(themeColors.purple, 0.1),
      30: alpha(themeColors.purple, 0.3),
      50: alpha(themeColors.purple, 0.5),
      70: alpha(themeColors.purple, 0.7),
      100: themeColors.purple,
    },
  },
  secondary: {
